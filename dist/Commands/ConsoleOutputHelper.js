...
exports.ConsoleOutputHelper = void 0;
const os_1 = __importDefault(require("os"));
class ConsoleOutputHelper {
    static formatText(text, options) {
        if (!text || (options === null || options === void 0 ? void 0 : options.formatDisabled))
            return text;
        ...
        const styles = {
            b: { open: "\x1b[1m", close: "\x1b[22m" },
            i: { open: "\x1b[3m", close: "\x1b[23m" },
            u: { open: "\x1b[4m", close: "\x1b[24m" },
        ...
        if ((options === null || options === void 0 ? void 0 : options.minLength) && processedText.length < options.minLength) {
            const padding = " ".repeat(options.minLength - processedText.length);
            processedText += padding;
            if (options.background) {
                const { background, minLength } = options, restOptions = __rest(options, ["background", "minLength"]);
    ...
    static write(message, options) {
        ...
        process.stdout.write((options === null || options === void 0 ? void 0 : options.formatDisabled) ? message : ConsoleOutputHelper.formatText(message, options));
    ...
    static writeln(message, options) {
        if (options && options.linesBefore) {
            for (let i = 0; i < options.linesBefore; i++) {
                process.stdout.write(os_1.default.EOL);
            }
        }
        process.stdout.write((options === null || options === void 0 ? void 0 : options.formatDisabled) ? message : ConsoleOutputHelper.formatText(message, options) + os_1.default.EOL);
        if (options && options.linesAfter) {
            for (let i = 0; i < options.linesAfter; i++) {
                process.stdout.write(os_1.default.EOL);
            }
    ...
    static success(message, options) {
        ...
        return this.writeln(formattedMessage, Object.assign({ linesBefore: 1, linesAfter: 1 }, options));
    }
...
exports.ConsoleOutputHelper = ConsoleOutputHelper;
